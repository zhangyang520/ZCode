...
class SettingDialog:Dialog{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        println("currentMonthNum:"+inventoryDate)
        if(inventoryDate.equals("")){
            ...
            var cacheMonthDate = DateUtil.parse2DateMonth(inventoryDate)
            ...
            println("currentMonthNum:"+currentMonthNum+"..cacheMonthNum:"+cacheMonthNum)
            //只有
            if(currentMonthNum==cacheMonthNum){
                ...
                AppPrefsUtils.putString(AppConstants.Inventory_Date_Name,DateUtil.dateFormatMonth(calendar.time))
